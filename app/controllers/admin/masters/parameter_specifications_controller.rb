class Admin::Masters::ParameterSpecificationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @parameter_specification.save
        ...
        format.html { redirect_to(admin_masters_lab_test_parameter_specifications_path(@lab_test)) }
