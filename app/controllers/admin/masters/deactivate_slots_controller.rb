class Admin::Masters::DeactivateSlotsController < ApplicationController
    ...
    respond_to do |format|
        ...
        format.js {
                     render :update do |page|
                        page.replace_html 'deactivate_slot', :partial => 'admin/masters/deactivate_slots/deactivate_slots_list'
                     end
                  }
              end
  end
  ...
  def create
   ...
   redirect_to(admin_masters_deactivate_slots_url())
  ...
  def update
    ...
    if @deactivate_slot.update_attributes(params[:deactivate_slot])
      ...
      redirect_to(admin_masters_deactivate_slot_url(@deactivate_slot) )
    else
      render :action => "edit"
    end
  end
  ...
  def time_slot
    ...
    render :update do |page|
      page.replace_html 'working_slot', :partial => 'admin/masters/doctors/edit_working_slots'
    end
 	end
